...
decisiontree.fit(X_train, np.ravel(y_train))
y_pred=decisiontree.predict(X_test)
print(decisiontree.score(X_test,np.ravel(y_test)))
...
plt.figure()
plot_confusion_matrix(cnf_matrix, title=('Confusion matrix of decision tree'))
mean = scores.mean()
stdev = scores.std()
